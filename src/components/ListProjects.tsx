    ...
    <>
      {projects.map((project) => {
        ...
        return (
          ...
          >
            <article className="p-8 sm:p-10 rounded-2xl flex flex-col sm:flex-row lg:flex-col md:space-x-4 align-c">
              <div>
                <h5 className="font-semibold text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white mb-4">
                  {title}
                </h5>
                <p className="text-white text-lg sm:text-xl md:text-2xl mb-0 sm:mb-12">
                  {excerpt}
                </p>
              </div>
              <GatsbyImage
